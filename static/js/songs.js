var teams = {
  ...
  omniB: [
    {
      name: "ALIVE",
      singer: "TOUCHED",
      info: "조명, 멜로디, 열기, 청춘, 우리는 누구보다도 뜨겁게 살아있음을.",
      image:
    ...
    },
    {
      name: "HI BULLY",
      singer: "TOUCHED",
      info: "두려워도 맞서 싸우리라. 시간을 따라 우리는 단단해지기에.",
      image:
    ...
    },
    {
      name: "좋지 아니한가",
      singer: "유다빈 밴드",
      info: "지치고 힘들었던 오늘, 함께 살아있는 이 순간 또한 좋지 아니한가!",
      image:
  ...
  comaB: [
    ...
    },
    {
      ...
      singer: "lggy Azalea",
      info: "이 무대는 코마 여성 멤버들의 힙한 매력을 볼 수 있는 무대입니다. 노래를 모르셔도 환호할 만한 킬링 포인트들이 많으니 같이 즐겨주세요!",
      image:
